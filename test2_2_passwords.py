...
# Чтение зашифрованных данных из бинарного файла
with open('encrypted.bin', 'rb') as f:
    encrypted_data = f.read()

# Попытка дешифрования для каждого пароля
...
for password in passwords:
    try:
        ...
        print("Пароль " + password + " не подошёл. Ошибка: {str(e)}")
        continue

if not decrypted_successfully:
    print("Ни один из паролей не подошел для дешифрования.")